 ...
 * LOG_INFO("ModuleName", QString::fromUtf8(u8"应用程序启动"));
 * LOG_ERROR("ModuleName", QString::fromUtf8(u8"发生错误: %1")).arg(errorMsg);
 * @endcode
 * 
 * @author 1553BTools
 * @date 2024
...
void Logger::setLogFile(const QString& filePath)
{
    ...
    if (m_logFile.open(QIODevice::WriteOnly | QIODevice::Append | QIODevice::Text)) {
        ...
        QT5COMPAT_SET_UTF8(m_logStream);
        m_initialized = true;
        m_logStream << "\n========================================\n";
        m_logStream << QString::fromUtf8(u8"[%1] 应用程序启动\n")
                       .arg(QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss"));
        m_logStream << "========================================\n";
        m_logStream.flush();
    } else {
        m_lastError = QString::fromUtf8(u8"无法打开日志文件: %1").arg(filePath);
        m_initialized = false;
    }
}
