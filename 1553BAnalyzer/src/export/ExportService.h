...
public:
     ...
     * - 包含表头行
     */
    bool exportToCsv(const QString& filePath, DataStore* store, DataScope scope = DataScope::FilteredData);
     ...
     * @return 导出成功返回true，失败返回false
     */
    bool exportToExcel(const QString& filePath, DataStore* store, DataScope scope = DataScope::FilteredData);
     ...
     * @return 导出成功返回true，失败返回false
     */
    bool exportToPdf(const QString& filePath, DataStore* store, DataScope scope = DataScope::FilteredData);
