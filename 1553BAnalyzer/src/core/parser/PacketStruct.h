 ...
 * 
 * 用于计算数据包在文件中的最小长度
 * 使用enum替代constexpr以兼容MSVC2015
 */
enum { SMbiMonPacketDataFixedPartSize = 16 };
...
inline QString messageTypeToString(MessageType type) {
    ...
    case MessageType::Broadcast: return QString::fromUtf8(u8"Broadcast");
    default: return QString::fromUtf8(u8"Unknown");
    }
}
...
using PacketParser::CMD;
using PacketParser::SMbiMonPacketHeader;
using PacketParser::SMbiMonPacketData;
using PacketParser::SMbiMonPacketMsg;
using PacketParser::SMbiMonPacketDataFixedPartSize;
using PacketParser::MessageType;
using PacketParser::detectMessageType;
using PacketParser::messageTypeToString;
using PacketParser::calculateDatasLength;
using PacketParser::cmdTerminalAddr;
using PacketParser::cmdSubAddr;
using PacketParser::cmdTR;
using PacketParser::cmdDataCount;
