...
void HexViewDialog::setupUI()
{
    ...
    QLabel* infoLabel = new QLabel(tr("文件: %1").arg(fileInfo.fileName()));
    ...
    QPushButton* loadMoreBtn = new QPushButton(tr("加载更多"));
...
void HexViewDialog::onLoadMore()
{
    if (m_currentOffset < m_fileSize) {
        ...
        QMessageBox::information(this, tr("提示"), tr("已到达文件末尾"));
    }
}
